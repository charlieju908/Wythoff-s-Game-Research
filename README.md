...
Wythoff's game is a two-player impartial combinatorial game involving two separate piles. Players take turns subtracting any one given amount from one or both piles, given by (a-k,b) or (a-k,b-k). The objective is to    be the player who is the last to subtract from the piles.
